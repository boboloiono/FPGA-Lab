...
module DE0_Nano_SOPC_mm_interconnect_1 (
	...
	wire   [6:0] clock_crossing_io_m0_translator_avalon_universal_master_0_address;       // clock_crossing_io_m0_translator:uav_address -> clock_crossing_io_m0_agent:av_address
	...
	wire   [6:0] sysid_control_slave_agent_m0_address;                                    // sysid_control_slave_agent:m0_address -> sysid_control_slave_translator:uav_address
	...
	wire  [80:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> sysid_control_slave_agent:cp_data
	...
	wire   [6:0] timer_s1_agent_m0_address;                                               // timer_s1_agent:m0_address -> timer_s1_translator:uav_address
	...
	wire  [80:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> timer_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                   // timer_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> timer_s1_agent:cp_channel
	...
	wire   [6:0] key_s1_agent_m0_address;                                                 // key_s1_agent:m0_address -> key_s1_translator:uav_address
	...
	wire  [81:0] key_s1_agent_rf_source_data;                                             // key_s1_agent:rf_source_data -> key_s1_agent_rsp_fifo:in_data
	...
	wire  [81:0] key_s1_agent_rsp_fifo_out_data;                                          // key_s1_agent_rsp_fifo:out_data -> key_s1_agent:rf_sink_data
	...
	wire  [80:0] cmd_mux_002_src_data;                                                    // cmd_mux_002:src_data -> key_s1_agent:cp_data
	...
	wire   [6:0] led_s1_agent_m0_address;                                                 // led_s1_agent:m0_address -> led_s1_translator:uav_address
	...
	wire  [81:0] led_s1_agent_rf_source_data;                                             // led_s1_agent:rf_source_data -> led_s1_agent_rsp_fifo:in_data
	...
	wire  [81:0] led_s1_agent_rsp_fifo_out_data;                                          // led_s1_agent_rsp_fifo:out_data -> led_s1_agent:rf_sink_data
	...
	wire  [80:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> led_s1_agent:cp_data
	...
	wire   [6:0] sw_s1_agent_m0_address;                                                  // sw_s1_agent:m0_address -> sw_s1_translator:uav_address
	...
	wire  [81:0] sw_s1_agent_rf_source_data;                                              // sw_s1_agent:rf_source_data -> sw_s1_agent_rsp_fifo:in_data
	...
	wire  [81:0] sw_s1_agent_rsp_fifo_out_data;                                           // sw_s1_agent_rsp_fifo:out_data -> sw_s1_agent:rf_sink_data
	...
	wire  [80:0] cmd_mux_004_src_data;                                                    // cmd_mux_004:src_data -> sw_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                   // sw_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                 // cmd_mux_004:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [80:0] clock_crossing_io_m0_agent_cp_data;                                      // clock_crossing_io_m0_agent:cp_data -> router:sink_data
	...
	wire  [80:0] sysid_control_slave_agent_rp_data;                                       // sysid_control_slave_agent:rp_data -> router_001:sink_data
	...
	wire         timer_s1_agent_rp_valid;                                                 // timer_s1_agent:rp_valid -> router_002:sink_valid
	wire  [80:0] timer_s1_agent_rp_data;                                                  // timer_s1_agent:rp_data -> router_002:sink_data
	wire         timer_s1_agent_rp_ready;                                                 // router_002:sink_ready -> timer_s1_agent:rp_ready
	wire         timer_s1_agent_rp_startofpacket;                                         // timer_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         timer_s1_agent_rp_endofpacket;                                           // timer_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [80:0] key_s1_agent_rp_data;                                                    // key_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [80:0] led_s1_agent_rp_data;                                                    // led_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [80:0] sw_s1_agent_rp_data;                                                     // sw_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [80:0] router_src_data;                                                         // router:src_data -> clock_crossing_io_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                        // clock_crossing_io_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [4:0] router_src_channel;                                                      // router:src_channel -> clock_crossing_io_m0_limiter:cmd_sink_channel
	...
	wire  [80:0] clock_crossing_io_m0_limiter_cmd_src_data;                               // clock_crossing_io_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         clock_crossing_io_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> clock_crossing_io_m0_limiter:cmd_src_ready
	wire   [4:0] clock_crossing_io_m0_limiter_cmd_src_channel;                            // clock_crossing_io_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [80:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> clock_crossing_io_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                       // clock_crossing_io_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [4:0] rsp_mux_src_channel;                                                     // rsp_mux:src_channel -> clock_crossing_io_m0_limiter:rsp_sink_channel
	...
	wire  [80:0] clock_crossing_io_m0_limiter_rsp_src_data;                               // clock_crossing_io_m0_limiter:rsp_src_data -> clock_crossing_io_m0_agent:rp_data
	...
	wire   [4:0] clock_crossing_io_m0_limiter_rsp_src_channel;                            // clock_crossing_io_m0_limiter:rsp_src_channel -> clock_crossing_io_m0_agent:rp_channel
	...
	wire   [4:0] clock_crossing_io_m0_limiter_cmd_valid_data;                             // clock_crossing_io_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire         timer_s1_agent_rdata_fifo_src_valid;                                     // timer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] timer_s1_agent_rdata_fifo_src_data;                                      // timer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         timer_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_001:in_0_ready -> timer_s1_agent:rdata_fifo_src_ready
	...
	DE0_Nano_SOPC_mm_interconnect_1_router router (
	...
	DE0_Nano_SOPC_mm_interconnect_1_router_001 router_001 (
	...
	DE0_Nano_SOPC_mm_interconnect_1_router_001 router_002 (
	...
	DE0_Nano_SOPC_mm_interconnect_1_router_001 router_003 (
	...
	DE0_Nano_SOPC_mm_interconnect_1_router_001 router_004 (
	...
	DE0_Nano_SOPC_mm_interconnect_1_router_001 router_005 (
	...
	DE0_Nano_SOPC_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (altpll_sys_c2_clk),                                      //        clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (altpll_sys_c2_clk),                                      //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (altpll_sys_c2_clk),                                      //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (altpll_sys_c2_clk),                                      //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (altpll_sys_c2_clk),                                      //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (altpll_sys_c2_clk),                                      //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (altpll_sys_c2_clk),                                      //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (altpll_sys_c2_clk),                                      //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (altpll_sys_c2_clk),                                      //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (altpll_sys_c2_clk),                                      //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (altpll_sys_c2_clk),                                      //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_Nano_SOPC_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (altpll_sys_c2_clk),                                      //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset

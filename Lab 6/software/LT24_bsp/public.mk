...
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DE0_Nano_SOPC.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4000050
SOPC_SYSID_FLAG += --sidp=0x4000050
ELF_PATCH_FLAG  += --sidp 0x4000050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1532685125
SOPC_SYSID_FLAG += --timestamp=1532685125
ELF_PATCH_FLAG  += --timestamp 1532685125
